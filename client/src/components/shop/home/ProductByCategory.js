      ...
      <section className="mx-4 mt-24 md:mx-12 md:mt-32 lg:mt-24">
        <div className="flex justify-between items-center">
          <div className="text-sm flex space-x-3">
            ...
            <span className="text-yellow-700 cursor-default font-semibold">{category}</span>
          </div>
          <div>
            <svg
              className="w-3 h-3"
              ...
              <Fragment key={index}>
                <div className="relative col-span-1 m-2">
                  <img
                    ...
                    className="w-full object-cover object-center cursor-pointer shadow rounded"
                    src={`${apiURL}/uploads/products/${item.pImages[0]}`}
                    alt=""
                  />
                  <div className="flex items-center justify-between mt-2">
                    <div className="text-gray-600 font-light truncate">
                      {item.pName.length > 50 ? item.pName.substring(0, 60) + "..." : item.pName}
